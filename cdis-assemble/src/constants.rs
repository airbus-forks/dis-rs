...
pub const MAX_NUMBER_OF_BEAMS: usize = (1usize << FIVE_BITS) - 1;
pub const MAX_TRACK_JAM_NUMBER_OF_TARGETS: usize = 15;
pub const MAX_EE_FUNDAMENTAL_PARAMS_LIST_LENGTH: usize = (1usize << FIVE_BITS) - 1;
pub const MAX_EE_BEAM_DATA_LIST_LENGTH: usize = (1usize << FIVE_BITS) - 1;
pub const MAX_EE_SITE_APP_PAIRS_LIST_LENGTH: usize = (1usize << SIX_BITS) - 1;
